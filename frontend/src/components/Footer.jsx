      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            {socialLinks.map((link) => {
              ...
              return (
                <a
                  ...
                  className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center hover:border-[#dc143c]/50 hover:bg-[#dc143c]/10 transition-all duration-300 group"
                  aria-label={link.name}
                >
                  {IconComponent && (
                    <IconComponent className="w-4 h-4 text-gray-400 group-hover:text-[#dc143c] transition-colors duration-300" />
                  )}
                </a>
              );
            })}
          ...
          >
            ...
            <div className="w-8 h-8 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center group-hover:border-[#dc143c]/50 group-hover:bg-[#dc143c]/10 transition-all duration-300">
